...
- $\mathbb{Z}/n\mathbb{Z}$ ::
  1) As best "we" can tell: This is "integers that are multiples of $n$". If $n$ is five, then it means $[0, 5, 10, ...]$
  _Or is it_ 2) is it "the cyclic group of order $n$"? aka $[0, 1, 2, ...n-1]$ ...?
