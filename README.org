...
I try to make it comprehensible (to me) below. Not quite there, I think. Is $x ∼ y$ pronounced "y is equivalent to x"? Is $x ∼ y ∈ H$ pronouced "the relation of $x ∼ y$ /is in/ $H$" ....? I need a pronounciation guide for sommov this stuff.
-----
...
- commutative :: $xy = yx$
- transative :: $x = y$ and $y = z$ $\implies x = z$
