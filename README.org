...
- [[https://byjus.com/maths/lagrange-theorem/][Lagrange Theorem]] :: Let $G$ be a finite group and $H$ be a subgroup of $G$. Then the order of $H$ divides the order of $G$. As a consequence, the order of every element also divides the order of $G$.
