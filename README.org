...
- "Definition 2.6 Let G be a group. An element x ∈ G is of finite order if $\langle x \rangle$ is finite." Can there be infinite-order groups that have $x$ of finite order?
